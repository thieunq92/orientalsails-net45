<%@ Page Language="C#" MasterPageFile="SailsMaster.Master" AutoEventWireup="true"
    Codebehind="Nationalities.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.Nationalities"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    <fieldset>
        ...
        <div class="settinglist">
            <div class="listbox">
                <ul>
                    <asp:Repeater ID="rptNationalities" runat="server" OnItemDataBound="rptNationalities_ItemDataBound"
                        OnItemCommand="rptNationalities_ItemCommand">
                        <ItemTemplate>
                            <li>
