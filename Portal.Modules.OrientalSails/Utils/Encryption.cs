...
namespace Portal.Modules.OrientalSails.Utils
{
    public class Skip32Cipher
    {
        ...
        /// <summary>
        /// Decrypts a unsigned 32-bit integer.
        /// </summary>
        /// <param name="value">Value to decrypt.</param>
        /// <returns>Decrypted value.</returns>
    ...
    public class VoucherCodeEncryption
    {
        ...
        public static uint Encrypt(uint code)
        {
            ...
            //if (result < 0)
            //{
            //    return Convert.ToInt32("1" + Math.Abs(result));
            //}
        ...
        public static void Decrypt(uint code, out int batchid)
        {
            ...
            var result = cipher.Decrypt(code);

            batchid = Convert.ToInt32(result/1000);
        }
    }
}